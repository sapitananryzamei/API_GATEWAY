...
//routes for site 2
$router->get('/users2', 'User2Controller@getUsers'); //show all users from site 2
$router->post('/users2', 'User2Controller@createUser'); //create users from site 2
$router->get('/users2/{id}', 'User2Controller@findUser'); //find users with specific ID from site 2
$router->put('/users2/{id}', 'User2Controller@updateUser'); //update users with specific ID from site 2
$router->delete('/users2/{id}', 'User2Controller@deleteUser'); //delete users with specific ID from site 2
